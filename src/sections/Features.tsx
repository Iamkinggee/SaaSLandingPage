    ...
    return(
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium mt-6 text-center max-w-2xl mx-auto">Where Power meets  <span className="text-lime-400">Simplicity</span>
                </h2>
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8 lg:grid-cols-3">
                    ...
                    <FeatureCard
                    title="Interractive Prototyping"
                    description="Engage your clients with prototypes that reacts to users actions"
                     className="md:col-span-2 lg:col-span-1"
                   >
                    <div className="aspect-video flex items-center justify-center">
                        <p className="text-4xl font-extrabold text-white/20 text-center">
                        We've Achieved {" "}
                         <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">incredible</span>{" "} growth this year
                        </p>
                    ...
                    description="Powerful commands to help you create designers faste"
